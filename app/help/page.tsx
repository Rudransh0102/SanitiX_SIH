...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "SanitiX supports a wide range of storage devices including HDDs (Hard Disk Drives), SSDs (Solid State Drives), USB flash drives, SD cards, and other removable storage media. The tool automatically detects device types and applies appropriate wiping methods for optimal security and performance.",
    category: "getting-started",
  ...
  },
  {
    ...
    answer:
      "SanitiX offers several industry-standard wiping methods: DoD 5220.22-M (3-pass and 7-pass), Gutmann (35-pass), and Random Data (1-pass). For most users, DoD 5220.22-M 3-pass provides excellent security. Use 7-pass or Gutmann for highly sensitive data. SSDs benefit from built-in secure erase commands when available.",
    category: "security",
    tags: ["methods", "algorithms", "standards"],
  },
  {
    id: "compliance-standards",
    question: "Which compliance standards does SanitiX meet?",
    answer:
      "SanitiX is designed to meet major compliance standards including NIST SP 800-88, DoD 5220.22-M, ISO 27001, and BSI-2011-01. The tool generates detailed certificates and reports that document the wiping process for audit purposes. Digital signatures can be applied to certificates for enhanced authenticity.",
    category: "compliance",
  ...
  },
  {
    ...
    answer:
      "First, ensure the device is properly connected and powered on. Try different USB ports or cables. Some devices may require administrator privileges to access. If the device appears in your system's disk management but not in SanitiX, try refreshing the device list. For encrypted or BitLocker-protected drives, you may need to unlock them first.",
  ...
  },
  {
    ...
    answer:
      "Yes, SanitiX allows you to pause and resume wipe operations. This is useful for long-running operations or when you need to use your computer for other tasks. The tool maintains progress state and can resume from where it left off. Note that some SSD secure erase operations cannot be paused once started.",
    category: "advanced",
  ...
  },
  {
    ...
    answer:
      "Currently, SanitiX processes one device at a time to ensure optimal performance and reliability. This approach allows for better monitoring, error handling, and resource management. You can queue multiple operations by completing one device before starting the next.",
    category: "advanced",
    ...
    <div className="flex justify-center min-h-screen">
      <div className="container px-4 py-8 md:px-6 lg:py-12 max-w-6xl">
        <PageHeader
          ...
          description="Find answers to common questions and learn how to use SanitiX effectively."
        />
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>Get started with SanitiX in 5 simple steps.</CardDescription>
          </CardHeader>
          <CardContent>
            {/* Added flex and items-stretch to align cards horizontally and make them the same height */}
            <div className="flex flex-col md:flex-row gap-4">
              {quickStartSteps.map((step) => {
                ...
                return (
                  <div
                    key={step.step}
                    className="flex-1 flex flex-col items-center text-center p-4 rounded-lg border bg-card/50"
                  >
