      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 pt-6">
            <Link
              href="/devices"
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 px-8 h-14 bg-blue-600 hover:bg-blue-700 shadow-lg text-white"
            >
        ...
        <Card className="mt-16 border-0 shadow-xl bg-gradient-to-br from-blue-50 to-indigo-50">
          ...
          <CardContent className="flex flex-col sm:flex-row gap-6 justify-center pt-4">
            <Link
              href="/devices"
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 px-8 h-14 bg-blue-600 hover:bg-blue-700 text-white"
            >
              Quick Start
            </Link>
            <Button
