...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen w-full max-w-none ml-0 lg:pl-15">
      <div className="container px-4 py-8 lg:py-12 max-w-4xl mx-auto">
        <PageHeader
          title="Settings"
          description="Configure SanitiX to meet your organization's compliance and security requirements."
        >
