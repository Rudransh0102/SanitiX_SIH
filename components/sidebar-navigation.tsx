...
//             <p className="text-xs text-sidebar-foreground/60">SanitiX v2.1</p>
...
//             </div>
//             <span className="text-lg font-bold">SanitiX</span>
//           </div>
...
//                       <Shield className="h-4 w-4 text-primary-foreground" />
//                     </div>
//                     <span className="text-lg font-bold text-sidebar-foreground">SanitiX</span>
//                   </div>
